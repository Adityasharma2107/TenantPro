      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl">
        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
          <div className="flex items-center gap-2">
            <span className="grid size-9 place-items-center rounded-lg bg-[#635985]/10 text-[#635985]">
              <Wrench size={18} />
            </span>
            <div>
              <h2 className="text-lg font-bold text-[#18122B]">Assign Technician</h2>
              <p className="text-xs text-slate-500">Dispatch an on-site technician for this repair.</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <div className="mt-5 space-y-4">
          {isTeamLoading ? (
            ...
            <div className="rounded-xl border border-dashed border-amber-200 bg-amber-50 p-4 text-center">
              <p className="text-sm font-semibold text-amber-800">No active technicians found.</p>
            ...
            <div>
              <label htmlFor="select-technician" className="block text-xs font-semibold uppercase tracking-wider text-slate-600">
                Choose Technician
              </label>
              <select
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
            ...
            <button
              ...
              className="rounded-xl bg-[#635985] px-5 py-2 text-sm font-semibold text-white shadow-md shadow-[#635985]/20 hover:bg-[#393053] disabled:opacity-50"
            >
